...
Gui:
  ...
  Gui, Add, Edit, x70 y535 w125 vAmount ;Readonly Edit1
  ...
  Gui, Add, Edit, x740 y410 w50 limit 2 number left vCarier ;Edit3
  Gui, Font, S12 CDefault, Verdana
 ...
 ; Gui, Add, Button, x670 y440 w65 h40, Dummy
  ...
  Gui, Add, Edit, x620 y560 w40 vReturnedCarier, %ReturnedCarier%    ; Carier Returned from PN. (Edit5)
  Gui, Font, s12, MS sans serif
  Gui, Add, StatusBar,,
  Gui, Add, Progress, vMyProgress w100 h20 x538 y610 Range0-%IdleTime% ;-Smooth
...
anchor("")
  ...
  SetTimer, Tip, 2000
  SB_SetParts( 200, 200, 70, 70, 100, 70) ; divide the statusbar in 6 parts.
...
Tip:
  ...
  If ACtrl = msctls_StatusBar321
    {
      MouseGetPos, XCtrl
      If XCtrl Between 5 and 200     ; part 1
          Tip = Read VSN
      If XCtrl Between 205 and 400   ; part 2
          Tip = Checked VSN
      If XCtrl Between 405 and 475   ; part 3
          Tip = Position
      If XCtrl Between 480 and 550   ; part 4
          Tip = Putty.log size
       If XCtrl Between 640 and 710  ; part 5
